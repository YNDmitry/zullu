...
Webflow.require('ix2').init({
  events: {
    ...
    'e-4': {
      ...
      target: {
        selector: '.section',
        originalId:
          'fcb026b9-642e-d37f-b97b-1fb5e5a61df5',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-9': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.design-btn.modal',
        originalId:
          '8f98b771-f42c-535d-377a-0390534f0866',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-11': {
      ...
      mediaQueries: ['main'],
      target: {
        selector: '.body-cursor-animation',
        originalId: '5fcb4f6137950357fa2e2da3',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-14': {
      ...
      action: {
        ...
        instant: false,
        config: { actionListId: 'slideInTop', autoStopEventId: 'e-15' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.card-wrapper.animation-3',
        originalId:
          '4ea1227e-5f99-df8b-a1a1-30e40d44144b',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-16': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.card-wrapper.animation-4',
        originalId:
          '358741a7-a5a0-1ce6-ecdf-ca3eb40f92f9',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-18': {
      ...
      action: {
        ...
        actionTypeId: 'SLIDE_EFFECT',
        instant: false,
        config: { actionListId: 'slideInTop', autoStopEventId: 'e-19' },
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.card-wrapper.animation-1',
        originalId:
          'eacffda9-0fa7-cf80-d9f8-62a716612775',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-20': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.card-wrapper.animation-2',
        originalId:
          '2dce925a-f2de-01a3-1dcd-2dd9e11c3110',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-26': {
      ...
      target: {
        ...
        originalId:
          '6f0c316a-c7b7-43a0-7007-0fc40906e1c7',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-28': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.grid-cards-wrapper-gradient',
        originalId:
          'e2829505-1831-0001-1416-21fd6fcec2c1',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-30': {
      ...
      mediaQueries: ['main'],
      target: {
        selector: '.from-section',
        originalId:
          '55d209e8-21fc-a7f4-54ce-69788426f4a3',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-31': {
      ...
      target: {
        selector: '.col-2',
        originalId:
          'fa5d0610-aa76-adbf-c772-9454116ff5d5',
        appliesTo: 'CLASS',
      },
      targets: [],
      config: {
    ...
    'e-33': {
      ...
      target: {
        ...
        originalId:
          'ed01e0ec-eaea-14c8-8d02-406e29147f76',
        appliesTo: 'CLASS',
      },
      targets: [],
      config: [
    ...
    'e-36': {
      ...
      action: {
        ...
        config: { actionListId: 'jello', autoStopEventId: 'e-37' },
        instant: false,
      },
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.card',
        originalId:
          '2ea78e80-f5bd-e39e-a5a7-cf2d4b70c732',
        appliesTo: 'CLASS',
      },
      targets: [],
      config: {
  ...
  actionLists: {
    'a-2': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.anim-icon.spin',
                  selectorGuids: [
                    '346302ce-6dd9-ac5a-922d-64edd5eddf78',
                    '8de89449-d100-66e6-f78a-82941357ff2e',
                  ],
                },
                zValue: 0,
                xUnit: 'DEG',
      ...
      createdOn: 1607281053921,
    },
    a: {
      id: 'a',
      title: 'bg-items-animations',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: '.element-anim-second',
                      selectorGuids: ['8a635d7c-7f67-94fc-731c-5b9d49e3da7c'],
                    },
                    yValue: 0,
                    xUnit: 'PX',
                    yUnit: '%',
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.big-text',
                  selectorGuids: ['5483ba80-5dcf-29f2-0b79-4e6dc54e92b6'],
                },
                value: 0,
                unit: '',
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.blue-txt',
                  selectorGuids: ['deb18ac7-b003-2a52-6c4f-48920af1f438'],
                },
                value: 0,
                unit: '',
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.zullu-txt',
                  selectorGuids: ['7bea4c0f-6203-0bf5-0736-7bcd200d7a08'],
                },
                value: 0,
                unit: '',
              },
    ...
    'a-4': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ['d4fa04e8-f1c0-4c25-1dd1-d66a4bfd3273'],
                },
                yValue: -150,
                xUnit: 'PX',
                yUnit: '%',
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1607282324329,
    },
    'a-5': {
      id: 'a-5',
      title: 'design-btn-animation',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: '.design-btn.modal',
                  selectorGuids: [
                    'fa58324e-28d7-e081-0c20-f50946ab364c',
                    '092730c1-8a40-7f9d-8b18-135f178a59f3',
                  ],
                },
                value: 0,
                unit: '',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.telephone-zullu',
                      selectorGuids: ['90633d75-dda4-1ff8-9453-d31b4302c75e'],
                    },
                    xValue: 0,
                    xUnit: 'px',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.bg-zullu',
                      selectorGuids: ['e35c5a6c-64e9-b926-9267-c7b367d07d47'],
                    },
                    xValue: 50,
                    yValue: null,
                    xUnit: 'px',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.telephone-zullu-2',
                      selectorGuids: ['053b0238-e3f3-436a-0a5a-5711fdf5684d'],
                    },
                    xValue: 10,
                    xUnit: 'px',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.shapes-bg',
                      selectorGuids: ['fab2f4c1-f361-08d5-05a3-ec73e69d0928'],
                    },
                    zValue: 30,
                    xUnit: 'DEG',
                    yUnit: 'DEG',
    ...
    'a-7': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: '.col-card._1',
                  selectorGuids: [
                    'f9be2f2d-0562-9936-22df-e064ed85cc20',
                    '9815d432-cc40-f6d9-382d-80e03229d13f',
                  ],
                },
                value: 0,
                unit: '',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: '.col-card._2',
                  selectorGuids: [
                    'f9be2f2d-0562-9936-22df-e064ed85cc20',
                    '73c14d92-62a9-1d5d-472e-8b4e71125d5d',
                  ],
                },
                value: 0,
                unit: '',
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: '.col-card._3',
                  selectorGuids: [
                    'f9be2f2d-0562-9936-22df-e064ed85cc20',
                    '462d42d4-3613-609d-8333-f89bb2cc5a03',
                  ],
                },
                value: 0,
                unit: '',
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1607283845433,
    },
    'a-8': {
      id: 'a-8',
      title: 'opacity-cards-2',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.gradient-card._1',
                  selectorGuids: [
                    '019bb5ee-438a-1a81-5e72-6eb1a00896bd',
                    'c86cfde9-3a9c-f544-cf10-abbbbdac2e8b',
                  ],
                },
                value: 0,
                unit: '',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.gradient-card._2',
                  selectorGuids: [
                    '019bb5ee-438a-1a81-5e72-6eb1a00896bd',
                    '31ed7573-0208-a313-20ef-d8e2aa47f687',
                  ],
                },
                value: 0,
                unit: '',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.gradient-card._3',
                  selectorGuids: [
                    '019bb5ee-438a-1a81-5e72-6eb1a00896bd',
                    'ccaf4d94-067b-03cd-8a36-98b97f3b9b6a',
                  ],
                },
                value: 0,
                unit: '',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.gradient-card._4',
                  selectorGuids: [
                    '019bb5ee-438a-1a81-5e72-6eb1a00896bd',
                    '6281d137-13d1-690e-58c4-c1322f2fecd0',
                  ],
                },
                value: 0,
                unit: '',
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1607284490706,
    },
    'a-9': {
      id: 'a-9',
      title: 'form-section-animation',
      continuousParameterGroups: [
        {
          id: 'a-9-p',
          type: 'MOUSE_X',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.heart',
                      selectorGuids: ['bdeb6221-64c7-c246-ab49-6e1d1bebd881'],
                    },
                    xValue: 20,
                    xUnit: 'px',
                    yUnit: 'PX',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.iphone-card._1',
                      selectorGuids: [
                        '5373ed76-ec52-28e3-95d6-8b0439934ca7',
                        'a342111e-568a-633d-83bc-8750c6cd45fe',
                      ],
                    },
                    xValue: 20,
                    xUnit: 'px',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.iphone-card._2',
                      selectorGuids: [
                        '5373ed76-ec52-28e3-95d6-8b0439934ca7',
                        'a61e4237-703a-0783-979b-5e25cebcdda2',
                      ],
                    },
                    xValue: -10,
                    yValue: null,
